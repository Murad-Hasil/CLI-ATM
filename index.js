...
if (pinAnswer.pin === pinCode) {
    ...
    if (operationAnswer.operation === "Withdraw") {
        ...
        if (withdrawAmount.amount <= accountBalance) {
            ...
            console.log(`Transaction successfull, Your remaining amount is ${accountBalance}`);
        }
        else {
        ...
        if (fastCashAmount.fastCash <= accountBalance) {
            ...
            console.log(`Transaction successfull, Your remaining acount balance is ${accountBalance}`);
        }
    }
